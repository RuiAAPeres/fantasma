...
assert_present 'usage_start_day="\$\(date -u \+%F\)"'
assert_present 'usage_end_day="\$\(date -u \+%F\)"'
assert_present 'cli usage events --start "\$usage_start_day" --end "\$usage_end_day" --json'
