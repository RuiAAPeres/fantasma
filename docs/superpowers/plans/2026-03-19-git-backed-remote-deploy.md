# Git-Backed Remote Deploy Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make the Fantasma remote-host deployment git-backed and deploy by pinned commit SHA instead of copying files into a mutable host directory.
...
### Task 3: Verify and migrate the live remote checkout
...
- [ ] **Step 3: Bootstrap the remote checkout**
