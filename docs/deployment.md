...
The benchmark stack keeps the same services as local development but lowers the worker poll interval to make derive-lag measurements meaningful instead of dominated by the default 5-second sleep.
