---
title: "Fantasma SDK Docs"
description: "Privacy-first mobile analytics SDKs for iOS, Android, and Flutter."
---
...
- runtime metadata such as platform and locale is added automatically

Choose your platform:

- [Shared SDK behavior](./sdk-behavior)
- [iOS SDK](./ios-sdk)
...
For a hosted solution, use [useFantasma.com](https://usefantasma.com).
