...
- seed_ingest: 900000 events in 31760ms (28337.36 events/s)
- event_metrics_ready_ms: 354ms
- session_metrics_ready_ms: 10519ms
- derived_metrics_ready_ms: 10519ms
- Budget: PASS

| Query | p50 (ms) | p95 (ms) | min (ms) | max (ms) |
| --- | ---: | ---: | ---: | ---: |
| events_count_day_grouped | 4 | 4 | 3 | 4 |
| events_count_hour_grouped | 30 | 31 | 28 | 38 |
| events_count_day_dim4_grouped | 9 | 10 | 8 | 12 |
| events_count_hour_dim4_grouped | 34 | 35 | 33 | 37 |
