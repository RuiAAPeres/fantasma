...
- event_metrics_ready_ms: 333ms
- session_metrics_ready_ms: 25509ms
- derived_metrics_ready_ms: 25509ms
- Budget: PASS

| Query | p50 (ms) | p95 (ms) | min (ms) | max (ms) |
| --- | ---: | ---: | ---: | ---: |
| events_count_day_grouped | 4 | 5 | 3 | 5 |
| events_count_hour_grouped | 31 | 37 | 30 | 75 |
| events_count_day_dim4_grouped | 9 | 14 | 7 | 18 |
| events_count_hour_dim4_grouped | 33 | 35 | 32 | 36 |
